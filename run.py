...
person1_image = face_recognition.load_image_file("jak.jpg")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

# โหลดภาพ Stop.jpg และให้ระบบจดจำใบหน้า
person2_image = face_recognition.load_image_file("tann.jpg")
person2_face_encoding = face_recognition.face_encodings(person2_image)[0]

person3_image = face_recognition.load_image_file("rich.jpg")
person3_face_encoding = face_recognition.face_encodings(person3_image)[0]

person4_image = face_recognition.load_image_file("chang.jpg")
